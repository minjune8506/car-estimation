...
public enum ErrorCode {
    ...
    MODEL_NOT_FOUND(HttpStatus.NOT_FOUND, 4001, "해당하는 모델을 찾을 수 없습니다."),
    CAR_NOT_FOUND(HttpStatus.NOT_FOUND, 4002, "해당하는 차량을 찾을 수 없습니다."),
    OPTION_NOT_FOUND(HttpStatus.NOT_FOUND, 4003, "해당하는 옵션을 찾을 수 없습니다."),
    SPEC_NOT_FOUND(HttpStatus.NOT_FOUND, 4004, "해당하는 스펙을 찾을 수 없습니다.");
